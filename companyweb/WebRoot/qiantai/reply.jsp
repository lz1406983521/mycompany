...
<table width="525" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
											<table>
											<tr><td></td><td align="right"><a href="reply?type=comment"><img src="images/msg.jpg" border="0" width="40"/></a></td></tr>
												<c:forEach items="${sessionScope.replyList}" var="reply">
													<tr>
														<td height="25" class="tableBorder_B_dashed" width="88%">
															<img src="images/left_ico.GIF" width="4" height="7"
																border="0">
															<a
																href="<%=path%>/reply?type=id&id=${reply.id}"
																title="">${reply.title}</a>
