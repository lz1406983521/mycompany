...
<table width="525" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="17" valign="bottom"><img src=" images/title_reply.gif" width="523" height="32" border="0" usemap="#Map" /></td>
  </tr>
  <tr>
    <td width="355" valign="middle">
    <table border="0" width="100%" align="left" cellpadding="0" cellspacing="0">
    <tr><td align="right"><a href="reply?type=comment"><img src="images/msg.jpg" border="0" width="40"/></a></td></tr>
      <tr>
      ...
      <tr>
        <td>${reply.content}</td>
          ...
          <tr>
        <td align="right"><b>留言时间</b>：${reply.addDate}</td>
      </tr>
      <tr><td><hr/></td></tr>
      <tr><td><b>答复:</b><br/>
      ${reply.reply}
         ...
         <tr>
        <td align="right"><b>答复时间</b>:${reply.replyDate}</td>
      </tr>
    </table>
    </td>
  </tr>
